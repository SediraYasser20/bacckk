 ...
 * Copyright (C) 2016		Yasser CarreÃ³n			<yacasia@gmail.com>
		...
		if ($objectsrc->fetch($origin_id)) {	// This include the fetch_lines
			...
			*/
			...
			if ($numAsked) {
				...
				if ($user->admin && (getDolGlobalInt('STOCK_CALCULATE_ON_RECEPTION') || getDolGlobalInt('STOCK_CALCULATE_ON_RECEPTION_CLOSE'))) {
