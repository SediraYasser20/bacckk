...
$langs->loadLangs(array("orders", "companies", "deliveries", "bills", "savtab@savtab", "savorders@savorders"));
...
elseif (empty($sav_status)) {
    ...
    // SAV Quantity Received (Read-only)
    print '<tr>';
    print '<td class="titlefield">'.$langs->trans("savorders_qty_recd", "savorders@savorders").'</td>';
    print '<td>';
    $qty_recd_display = isset($object->array_options['options_savorders_qty_recd']) ? (float)$object->array_options['options_savorders_qty_recd'] : 0;
    print $qty_recd_display;
    print '</td>';
    print '</tr>';

    // SAV Quantity Delivered to Customer (Read-only)
    print '<tr>';
    print '<td class="titlefield">'.$langs->trans("savorders_qty_deliv_tocust", "savorders@savorders").'</td>';
    print '<td>';
    $qty_deliv_tocust_display = isset($object->array_options['options_savorders_qty_deliv_tocust']) ? (float)$object->array_options['options_savorders_qty_deliv_tocust'] : 0;
    print $qty_deliv_tocust_display;
    print '</td>';
    print '</tr>';
